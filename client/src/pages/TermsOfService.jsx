  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="space-y-4 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
        ...
        <p>
          Once a seller posts a product on this site, the sale is conducted directly and
          solely between the seller and the buyer. Interested buyers are expected to
          contact the seller directly via WhatsApp (using the &quot;Contact Seller&quot;
